  ...
  describe 'check_domain' do
    context 'valid domain' do
      it 'returns correct domain' do
        ...
        result2 = WildcardDomainChecker.check_domain('forum.okse.io', 'forum.okse.io')
        expect(result2[0]).to eq('forum.okse.io')
    ...
    context 'invalid domain' do
      it "doesn't return the domain" do
        ...
        result2 = WildcardDomainChecker.check_domain('forum.okse.io', 'forum.okse.io.evil.com')
        expect(result2).to eq(nil)

        result3 = WildcardDomainChecker.check_domain('forum.okse.io', 'www.forum.okse.io')
        expect(result3).to eq(nil)

        result4 = WildcardDomainChecker.check_domain('www.*.discourse.org', 'www.forum.okse.io')
        expect(result4).to eq(nil)

        result5 = WildcardDomainChecker.check_domain('forum.okse.io', "forum.okse.io\nforum.okse.io.evil.com")
