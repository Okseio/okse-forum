...
# Documentation: https://forum.okse.io/t/importing-from-phpbb3/30810
...
if ARGV.length != 1 || !File.exists?(ARGV[0])
  ...
  STDERR.puts '', 'Still having problems? Take a look at https://forum.okse.io/t/importing-from-phpbb3/30810'
  exit 1
end
